...
<div class="container">
  <div class="jumbotron bg-light">
    ...
    <p> CMS is a website which lets you submit an article which upon approval will be up on our website and you can get a good amount of reach from here!
...
<div class="card mb-3" style="max-width: 740px; max-height:500px; overflow:hidden;">
  <div class="row g-0">
    <div class="col-md-4">
      <img style="width:200px;" src="image/<?php echo $data["image"]; ?>" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
        <p><?php echo $data["datetime"]; ?></p>
        <h5 class="card-title"><?php echo $data["title"]; ?></h5>
        <p style="max-height:150px; overflow:hidden;" class="card-text"><?php echo $data["description"]; ?></p>
        <button class="btn btn-primary" onclick="window.location.href='blog.php?id=<?php echo $data['id']; ?>'">Read More</button>
        <button class="btn btn-primary" onclick="window.location.href='update.php?id=<?php echo $data['id']; ?>'">Update</button>
...
<p class="p-2 mb-0 text-center text-light bg-secondary display-block">Copyright &copy; kamleen <script>document.write(new Date().getFullYear());</script></p>
