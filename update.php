...
?>  
        ...
        <form action="editpost.php" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3 form-control">
                ...
                <input value="<?php echo $data["title"]; ?>" type="text" class="form-control" name="title" required id="exampleFormControlInput1" placeholder="xyz"> <br>
            </div>
            <div class="mb-3 form-control">
                <label for="exampleFormControlTextarea1" class="form-label">Description </label>
                <input value="<?php echo $data["description"]; ?>" class="form-control" required name="description" id="exampleFormControlTextarea1" rows="3"><br>
            </div> 
            <div class="mb-3 form-control">
                <label for="formFile" class="form-label">Media</label>
                <input value="fdsfds" class="form-control" name="media" type="file" required id="formFile"><br>
            </div>
            <div class="mb-3 ">
